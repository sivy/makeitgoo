...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Deploy.deploy_id'
        db.delete_column('mgapp_deploy', 'deploy_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Deploy.deploy_id'
        db.add_column('mgapp_deploy', 'deploy_id', self.gf('django.db.models.fields.TextField')(default=0), keep_default=False)
